...
def agarrartenedor(id_filosofo):
    """Trata de tomar los tenedor izquierdo y derecho (en ese orden) y 
...
def liberartenedor(id_filosofo):
    """Liberación de los tenedor adyacentes al filosofo"""
